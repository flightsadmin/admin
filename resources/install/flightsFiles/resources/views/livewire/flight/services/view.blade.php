...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div>
                        <input wire:model.live.debounce.500ms="keyWord" type="text" class="form-control form-control-sm" name="search"
                            id="search" placeholder="Search Service">
                    </div>
            ...
            <div class="card-body">
                @include('livewire.flight.services.modals')
                <div class="row">
                            ...
                            <div>
                                <div class="dropdown p-2">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a data-bs-toggle="modal" data-bs-target="#dataModal" class="dropdown-item bi-pencil-square"
                                                wire:click="edit({{ $row->id }})"> Edit </a></li>
                                        <li><a class="dropdown-item bi-trash3"
                                                onclick="confirm('Confirm Delete Service id {{ $row->id }}? \nDeleted Service cannot be recovered!')||event.stopImmediatePropagation()"
