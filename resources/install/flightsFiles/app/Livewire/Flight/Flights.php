...
class Flights extends Component
{
    ...
    public function render()
    {
        ...
        $flights = Flight::with('service', 'movement')
                        ...
                        ->paginate();
        return view('livewire.flight.flights.view', [
    ...
    public function generatePDF()
    {
        ...
        $pdf = new Dompdf();
        $pdf->loadHtml(view('livewire.flight.services.download', compact('selectedFlight'))->render());
        ...
        $emailData = [
            ...
            'message' => 
                    ...
                    Regards, <br>'.
                    setting('site_name') ?? config('app.name') . ' Site Administrator. <br>
