        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <h4>{{ $userId ? 'Edit User' : 'Create New User' }}</h4>
                </h5>
                <button wire:click="$refresh" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 d-flex align-items-center justify-content-evenly">
                            @if ($userId)
                                ...
                                <input type="checkbox" id="changePassword" class="form-check-input ms-2"
                                    wire:model.live="changePassword" autocomplete="off">
                                @error('password')
                                    <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            @endif
                                            ...
                                            @foreach ($roles as $role)
                                                <tr>
                                                    <td class="text-center" width="40">
                                                        <input type="checkbox" id="selectedRoles.{{ $role->id }}"
                                                            wire:model.blur="selectedRoles" value="{{ $role->id }}"
