    ...
    <div class="container-fluid">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block">
                <a href="{{ route(config('admin.blogRoute')) }}" wire:navigate class="nav-link">@yield('title', config('admin.appName', 'app.name'))</a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="#" class="dropdown-item">
                        <i class="bi-envelope me-2"></i> 4 new messages
                        <span class="float-end text-secondary fs-7">3 mins</span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="#" class="dropdown-item">
                        <i class="bi-people-fill me-2"></i> 8 friend requests
                        <span class="float-end text-secondary fs-7">12 hours</span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="#" class="dropdown-item">
                        <i class="bi-file-earmark-fill me-2"></i> 3 new reports
